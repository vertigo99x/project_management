...
urlpatterns = [
    ...
    path('projects/update/<uuid:uuid>/', views.UpdateProjectView.as_view(), name='update_project'),
    path('projects/delete/<uuid:uuid>/', views.DeleteProjectView.as_view(), name='delete_project'),
